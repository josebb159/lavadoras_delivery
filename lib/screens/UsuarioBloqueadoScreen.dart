                          ...
                          children: [
                            ...
                            _buildPaymentMethod(
                              ...
                              onTap: () async {
                                ...
                                final multa =
                                    configData?['multa_cliente']?.toString() ??
                                    '0';

                                // 2️⃣ Crear referencia única
                                final referenceCode =
                                    "PayU-$userid-${DateTime.now().millisecondsSinceEpoch}";

                                // 3️⃣ Generar firma EXACTAMENTE igual que en PHP
                                String apiKey =
                                    configData?['payu_api_key'] ??
                                    ''; // Tu API Key real de PayU
                                String merchantId =
                                    configData?['payu_merchant_id'] ?? '';
                                String currency = "COP";
                                String signatureRaw =
                                    "$apiKey~$merchantId~$referenceCode~$multa~$currency";
                                ...
                                final accountId =
                                    configData?['payu_account_id'] ?? '';
                                final checkoutUrl =
                                    "https://pay.alquilav.com/pay.php?"; //configData?['payu_checkout_url'] ?? '';
                                final responseUrl =
                                    configData?['payu_response_url'] ?? '';
                                final confirmationUrl =
                                    configData?['payu_confirmation_url'] ?? '';
                            ...
                            _buildPaymentMethod(
                              "Bancolombia",
                              configData?['bancolombia_habilitado'],
                              configData?['bancolombia_cuenta'],
                            ),
                            _buildPaymentMethod(
                              "Nequi",
                              configData?['nequi_habilitado'],
                              configData?['nequi_cuenta'],
                            ),
                            _buildPaymentMethod(
                              "Daviplata",
                              configData?['daviplata_habilitado'],
                              configData?['daviplata_cuenta'],
                            ),
                          ],
                        ),
                      ),
